        ...
        <div className={styles.playlist}>
            <div className={styles.firstpage}>
                ...
                <div className={styles.info}>
                    <div className={`pt1 ${styles.title}`}>{title}</div>
                    <div className={`pt1 ${styles.desc}`}>{Description}</div>
                    <div className={`pt2 ${styles.playlistInfo}`}>{list.length} songs<span className="dot"></span> {formatTotal(totalDuration)}</div>
